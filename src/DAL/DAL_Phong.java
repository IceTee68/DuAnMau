...
public class DAL_Phong {
    ...
    // thành tạo để tìm mã phòng trong phiếu thuê phòng
    public static ResultSet findMaPhongBySoPhong(String soPhong)
    {
        String sql = "select * from Phong where TenPhong = ?";
        return helper.sqlHelper.executeQuery(sql, soPhong);
    }
    
    public static ResultSet findTrangThaiPhongByMaPhong(String maPhong)
    {
