...
public class GUI_pnl_ChiTietPhong extends javax.swing.JPanel {
    ...
    public void load() {
        ...
        if (lblSetTrangThai.getText().equals("Phòng Trống") || lblSetTrangThai.getText().equals("Trả Phòng")) {
    ...
    private void initComponents() {
        ...
        lblSeDatCoc = new javax.swing.JLabel();
        ...
        lblSeDatCoc.setBackground(new java.awt.Color(255, 255, 255));
        lblSeDatCoc.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        lblSeDatCoc.setForeground(new java.awt.Color(255, 255, 255));
        lblSeDatCoc.setText("200K");
        sdoChiTietPhong.add(lblSeDatCoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 40, 30));
    ...
    public javax.swing.JLabel lblSeDatCoc;
    ...
    private javax.swing.JLabel lblThangRa;
    private javax.swing.JLabel lblThangVao;
    ...
    private javax.swing.JMenuItem mniDonPhong;
    private javax.swing.JMenuItem mniKhachRaNgoai;
    private javax.swing.JMenuItem mniThanhToanNhom;
...
{
//   DAL.DAL_Phong.findMaPhongBySoPhong(lblSoPhong.getText());
//                System.out.println(lblSoPhong.getText());
    BLL.BLL_PhieuThuePhong.findMaPhongbyTenPhong(lblSoPhong);
//    BLL.BLL_PhieuThuePhong.select(lblSoPhong);
